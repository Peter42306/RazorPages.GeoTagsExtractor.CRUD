...
namespace RazorPages.GeoTagsExtractor.CRUD.Pages
{
	public class DeleteModel : PageModel
	{
		...
		public DeleteModel(ApplicationContext context, IWebHostEnvironment environment)
		{
			_context = context;
		...
		public async Task<IActionResult> OnPostAsync(int? id)
		{
			...
			var imageById = await _context.Files.FindAsync(id);

			if (imageById!=null)
			{
				FileById=imageById;
				_context.Files.Remove(FileById);
